    ...
    return (
      <div>
        <PageHeader
          title={'Lectures'}
          subtitle={
            <Link to={`/course/${this.props.match.params.course}/create-new-lecture`}> Create a new lecture</Link>
          }
          links={[
            {
              name: 'Home',
        ...
        <div className="content">
          ...
          {this.props.lectures.items.map(lecture => <LectureItem key={lecture.id} lecture={lecture} />)}
        </div>
      </div>
    )
  }
