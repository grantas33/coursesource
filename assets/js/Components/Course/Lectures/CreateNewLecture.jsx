            ...
            <div className="box-body">
              <form role="form">
                ...
                <div className={"form-group" + (this.state.editted.title && this.state.validations.title ? " has-error" : "")}>
                  <label>Name</label>
                  <input value={this.state.newLecture.title} onChange={(event) => this.handleUpdateField("title",event.target.value)} className={"form-control"} placeholder="Enter ..." />
                ...
                <div className={"form-group" + (this.state.validations.description ? " has-error" : "")}>
                  ...
                  <textarea value={this.state.newLecture.description} onChange={(event) => this.handleUpdateField("description",event.target.value)} className={"form-control"} rows={3} placeholder="Enter ..." />
                ...
                <div className={"form-group" + (this.state.editted.start_date && this.state.validations.start_date ? " has-error" : "")}>
                  ...
                  {this.state.editted.start_date && this.state.validations.start_date && <span className="help-block">{this.state.validations.start_date}</span>}                
                </div>
