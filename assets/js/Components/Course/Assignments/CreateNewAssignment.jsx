            ...
            <div className="box-body">
              <form role="form">
                ...
                >
                  <label>Name</label>
                  <input
                    value={this.state.newAssignment.title}
                ...
                <div className={'form-group' + (this.state.validations.description ? ' has-error' : '')}>
                  ...
                  <textarea
                    value={this.state.newAssignment.description}
                ...
                <div className="form-group">
                  <div className="checkbox">
                    <label>
                      <input
                        value={!this.state.newAssignment.is_gradeable}
                        onClick={() => this.handleUpdateField('is_gradeable', !this.state.newAssignment.is_gradeable)}
                        type="checkbox"
                      />
                      Gradeable
                    </label>
                  ...
                  <div className="checkbox">
                    <label>
                      <input
                        value={!this.state.newAssignment.is_submittable}
                        onClick={() =>
                          this.handleUpdateField('is_submittable', !this.state.newAssignment.is_submittable)
                        }
                        type="checkbox"
                      />
                      Submittable
                ...
                <div
                  className={
                    'form-group' +
                    (this.state.editted.deadline_date && this.state.validations.deadline_date ? ' has-error' : '')
                  }
                >
                  ...
                  />
                  {this.state.editted.deadline_date &&
                    this.state.validations.deadline_date && (
...
export default connect(mapStateToProps, mapDispatchToProps)(CreateNewAssignment)
